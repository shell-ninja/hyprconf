...
| <img src="https://github.com/shell-ninja/Screen-Shots/blob/main/hyprconf-noct/hyprconf-apps.png?raw=true" width="340" alt="Hyprconf Apps" /> | **Hyprconf Apps** | Python GUI apps for changing hyprland settings and updating packages. |
